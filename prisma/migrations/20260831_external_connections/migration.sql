...
-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "external_connections_ownerId_provider_key" ON "external_connections"("ownerId", "provider");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "external_connections_ownerId_status_idx" ON "external_connections"("ownerId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "evidence_sources_connectionId_idx" ON "evidence_sources"("connectionId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "evidence_sources_ownerId_sourceType_idx" ON "evidence_sources"("ownerId", "sourceType");
